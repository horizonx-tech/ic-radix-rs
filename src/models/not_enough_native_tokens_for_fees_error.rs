...
pub struct NotEnoughNativeTokensForFeesError {
    ...
    pub fee_estimate: Box<models::ResourceAmount>,
}

impl NotEnoughNativeTokensForFeesError {
    pub fn new(r#type: String, available: models::ResourceAmount, fee_estimate: models::ResourceAmount) -> NotEnoughNativeTokensForFeesError {
