...
impl StateEntityDetailsResponseNonFungibleResourceDetails {
    pub fn new(r#type: models::StateEntityDetailsResponseItemDetailsType, role_assignments: models::ComponentEntityRoleAssignments, non_fungible_id_type: models::NonFungibleIdType, total_supply: String, total_minted: String, total_burned: String) -> StateEntityDetailsResponseNonFungibleResourceDetails {
