...
pub struct ConstructionDeriveRequestMetadataExitingUnstakes {
    ...
    pub validator: Box<models::EntityIdentifier>,
    #[serde(rename = "epoch_unlock")]
    pub epoch_unlock: i64,
}

impl ConstructionDeriveRequestMetadataExitingUnstakes {
    pub fn new(r#type: String, validator: models::EntityIdentifier, epoch_unlock: i64) -> ConstructionDeriveRequestMetadataExitingUnstakes {
