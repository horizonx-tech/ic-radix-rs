...
pub struct VirtualParentData {
    ...
    pub entity_set_identifier: Box<models::EntitySetIdentifier>,
    #[serde(rename = "virtual_data_object")]
    pub virtual_data_object: Box<models::DataObject>,
}

impl VirtualParentData {
    pub fn new(r#type: String, entity_set_identifier: models::EntitySetIdentifier, virtual_data_object: models::DataObject) -> VirtualParentData {
        VirtualParentData {
            r#type,
