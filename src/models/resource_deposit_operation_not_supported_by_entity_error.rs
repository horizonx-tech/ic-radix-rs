...
pub struct ResourceDepositOperationNotSupportedByEntityError {
    ...
    pub resource_deposit_not_supported: Box<models::ResourceIdentifier>,
}

impl ResourceDepositOperationNotSupportedByEntityError {
    pub fn new(r#type: String, entity_identifier: models::EntityIdentifier, resource_deposit_not_supported: models::ResourceIdentifier) -> ResourceDepositOperationNotSupportedByEntityError {
