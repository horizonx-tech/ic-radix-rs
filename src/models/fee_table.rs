...
pub struct FeeTable {
    ...
    pub per_up_substate_fee: Vec<models::UpSubstateFeeEntry>,
    #[serde(rename = "per_byte_fee")]
    pub per_byte_fee: Box<models::ResourceAmount>,
}

impl FeeTable {
    pub fn new(per_up_substate_fee: Vec<models::UpSubstateFeeEntry>, per_byte_fee: models::ResourceAmount) -> FeeTable {
        FeeTable {
            per_up_substate_fee,
