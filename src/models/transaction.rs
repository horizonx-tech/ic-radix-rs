...
impl Transaction {
    pub fn new(transaction_identifier: models::TransactionIdentifier, operation_groups: Vec<models::OperationGroup>, metadata: models::CommittedTransactionMetadata) -> Transaction {
        Transaction {
