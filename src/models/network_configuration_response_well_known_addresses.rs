...
impl NetworkConfigurationResponseWellKnownAddresses {
    pub fn new(xrd: String, secp256k1_signature_virtual_badge: String, ed25519_signature_virtual_badge: String, package_of_direct_caller_virtual_badge: String, global_caller_virtual_badge: String, system_transaction_badge: String, package_owner_badge: String, validator_owner_badge: String, account_owner_badge: String, identity_owner_badge: String, package_package: String, resource_package: String, account_package: String, identity_package: String, consensus_manager_package: String, access_controller_package: String, transaction_processor_package: String, metadata_module_package: String, royalty_module_package: String, access_rules_package: String, role_assignment_module_package: String, genesis_helper_package: String, faucet_package: String, consensus_manager: String, genesis_helper: String, faucet: String, pool_package: String, transaction_tracker: String) -> NetworkConfigurationResponseWellKnownAddresses {
