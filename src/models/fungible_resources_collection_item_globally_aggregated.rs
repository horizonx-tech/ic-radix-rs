...
impl FungibleResourcesCollectionItemGloballyAggregated {
    pub fn new(aggregation_level: models::ResourceAggregationLevel, resource_address: String, amount: String, last_updated_at_state_version: i64) -> FungibleResourcesCollectionItemGloballyAggregated {
