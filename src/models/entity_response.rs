...
pub struct EntityResponse {
    ...
    pub state_identifier: Box<models::StateIdentifier>,
    /// Balances associated with the entity.
    #[serde(rename = "balances")]
    pub balances: Vec<models::ResourceAmount>,
    /// Data associated with the entity.
    #[serde(rename = "data_objects")]
    pub data_objects: Vec<models::DataObject>,
}

impl EntityResponse {
    pub fn new(state_identifier: models::StateIdentifier, balances: Vec<models::ResourceAmount>, data_objects: Vec<models::DataObject>) -> EntityResponse {
        EntityResponse {
