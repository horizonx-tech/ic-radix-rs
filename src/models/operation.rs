...
pub struct Operation {
    ...
    pub substate: Option<Box<models::Substate>>,
    #[serde(rename = "amount", skip_serializing_if = "Option::is_none")]
    pub amount: Option<Box<models::ResourceAmount>>,
...
impl Operation {
    pub fn new(r#type: String, entity_identifier: models::EntityIdentifier) -> Operation {
        Operation {
            r#type,
