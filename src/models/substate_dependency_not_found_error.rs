...
pub struct SubstateDependencyNotFoundError {
    ...
    pub substate_identifier_not_found: Box<models::SubstateIdentifier>,
}

impl SubstateDependencyNotFoundError {
    pub fn new(r#type: String, substate_identifier_not_found: models::SubstateIdentifier) -> SubstateDependencyNotFoundError {
