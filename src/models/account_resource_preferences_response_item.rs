...
impl AccountResourcePreferencesResponseItem {
    pub fn new(resource_address: String, resource_preference_rule: models::AccountResourcePreferenceRule, last_updated_at_state_version: i64) -> AccountResourcePreferencesResponseItem {
