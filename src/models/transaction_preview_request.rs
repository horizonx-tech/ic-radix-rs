...
impl TransactionPreviewRequest {
    pub fn new(manifest: String, start_epoch_inclusive: i64, end_epoch_exclusive: i64, tip_percentage: i32, nonce: i64, signer_public_keys: Vec<models::PublicKey>, flags: models::TransactionPreviewRequestFlags) -> TransactionPreviewRequest {
