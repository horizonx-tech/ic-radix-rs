...
impl TransactionPreviewResponse {
    pub fn new(encoded_receipt: String, receipt: serde_json::Value, resource_changes: Vec<serde_json::Value>, logs: Vec<models::TransactionPreviewResponseLogsInner>) -> TransactionPreviewResponse {
