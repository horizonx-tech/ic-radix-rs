...
impl ValidatorCollectionItem {
    pub fn new(address: String, stake_vault: models::ValidatorVaultItem, pending_xrd_withdraw_vault: models::ValidatorVaultItem, locked_owner_stake_unit_vault: models::ValidatorVaultItem, pending_owner_stake_unit_unlock_vault: models::ValidatorVaultItem, state: Option<serde_json::Value>, metadata: models::EntityMetadataCollection, effective_fee_factor: models::ValidatorCollectionItemEffectiveFeeFactor) -> ValidatorCollectionItem {
