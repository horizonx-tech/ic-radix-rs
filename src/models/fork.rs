...
pub struct Fork {
    #[serde(rename = "name")]
    pub name: String,
    #[serde(rename = "is_candidate")]
    pub is_candidate: bool,
    #[serde(rename = "engine_identifier")]
    pub engine_identifier: Box<models::EngineIdentifier>,
    #[serde(rename = "engine_configuration")]
    pub engine_configuration: Box<models::EngineConfiguration>,
}

impl Fork {
    pub fn new(name: String, is_candidate: bool, engine_identifier: models::EngineIdentifier, engine_configuration: models::EngineConfiguration) -> Fork {
        Fork {
            name,
            is_candidate,
