...
pub struct TransactionStatusResponse {
    ...
    pub permanently_rejects_at_epoch: Option<Option<i64>>,
...
impl TransactionStatusResponse {
    pub fn new(ledger_state: models::LedgerState, status: models::TransactionStatus, intent_status: models::TransactionIntentStatus, intent_status_description: String, known_payloads: Vec<models::TransactionStatusResponseKnownPayloadItem>) -> TransactionStatusResponse {
