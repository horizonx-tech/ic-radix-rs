...
pub struct UpSubstateFeeEntry {
    ...
    pub substate_type_identifier: Box<models::SubstateTypeIdentifier>,
    #[serde(rename = "fee")]
    pub fee: Box<models::ResourceAmount>,
}

impl UpSubstateFeeEntry {
    pub fn new(substate_type_identifier: models::SubstateTypeIdentifier, fee: models::ResourceAmount) -> UpSubstateFeeEntry {
        UpSubstateFeeEntry {
