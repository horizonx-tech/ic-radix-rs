...
pub struct NotValidatorOwnerError {
    ...
    pub r#type: String,
    #[serde(rename = "owner")]
    pub owner: Box<models::EntityIdentifier>,
    #[serde(rename = "user")]
    pub user: Box<models::EntityIdentifier>,
}

impl NotValidatorOwnerError {
    pub fn new(r#type: String, owner: models::EntityIdentifier, user: models::EntityIdentifier) -> NotValidatorOwnerError {
