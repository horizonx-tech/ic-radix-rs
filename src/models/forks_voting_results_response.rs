...
pub struct ForksVotingResultsResponse {
    #[serde(rename = "forks_voting_results")]
    pub forks_voting_results: Vec<models::ForkVotingResult>,
}

impl ForksVotingResultsResponse {
    pub fn new(forks_voting_results: Vec<models::ForkVotingResult>) -> ForksVotingResultsResponse {
