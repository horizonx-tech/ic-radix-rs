...
pub struct ForkVotingResult {
    #[serde(rename = "epoch")]
    pub epoch: i64,
    #[serde(rename = "candidate_fork_id")]
    pub candidate_fork_id: String,
    #[serde(rename = "stake_percentage_voted")]
    pub stake_percentage_voted: f32,
}

impl ForkVotingResult {
    pub fn new(epoch: i64, candidate_fork_id: String, stake_percentage_voted: f32) -> ForkVotingResult {
        ForkVotingResult {
            epoch,
            candidate_fork_id,
