...
pub struct EngineConfigurationResponse {
    ...
    pub checkpoints: Vec<models::EngineCheckpoint>,
    #[serde(rename = "forks")]
    pub forks: Vec<models::Fork>,
}

impl EngineConfigurationResponse {
    pub fn new(checkpoints: Vec<models::EngineCheckpoint>, forks: Vec<models::Fork>) -> EngineConfigurationResponse {
