...
impl StateKeyValueStoreDataResponse {
    pub fn new(ledger_state: models::LedgerState, key_value_store_address: String, entries: Vec<models::StateKeyValueStoreDataResponseItem>) -> StateKeyValueStoreDataResponse {
