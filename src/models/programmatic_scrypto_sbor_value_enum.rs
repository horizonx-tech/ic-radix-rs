...
impl ProgrammaticScryptoSborValueEnum {
    pub fn new(kind: models::ProgrammaticScryptoSborValueKind, variant_id: i32, fields: Vec<models::ProgrammaticScryptoSborValue>) -> ProgrammaticScryptoSborValueEnum {
