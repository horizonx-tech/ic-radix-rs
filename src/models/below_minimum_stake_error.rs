...
pub struct BelowMinimumStakeError {
    ...
    pub attempted_to_stake: Box<models::ResourceAmount>,
}

impl BelowMinimumStakeError {
    pub fn new(r#type: String, minimum_stake: models::ResourceAmount, attempted_to_stake: models::ResourceAmount) -> BelowMinimumStakeError {
