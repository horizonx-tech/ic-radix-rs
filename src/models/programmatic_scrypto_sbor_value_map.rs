...
impl ProgrammaticScryptoSborValueMap {
    pub fn new(kind: models::ProgrammaticScryptoSborValueKind, key_kind: models::ProgrammaticScryptoSborValueKind, value_kind: models::ProgrammaticScryptoSborValueKind, entries: Vec<models::ProgrammaticScryptoSborValueMapEntry>) -> ProgrammaticScryptoSborValueMap {
