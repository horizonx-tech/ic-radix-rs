...
pub struct ConstructionBuildRequest {
    ...
    pub fee_payer: Box<models::EntityIdentifier>,
...
impl ConstructionBuildRequest {
    pub fn new(network_identifier: models::NetworkIdentifier, operation_groups: Vec<models::OperationGroup>, fee_payer: models::EntityIdentifier) -> ConstructionBuildRequest {
