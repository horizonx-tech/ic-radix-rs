...
pub struct CommittedTransactionsRequest {
    ...
    pub state_identifier: Box<models::PartialStateIdentifier>,
...
impl CommittedTransactionsRequest {
    ...
    pub fn new(network_identifier: models::NetworkIdentifier, state_identifier: models::PartialStateIdentifier) -> CommittedTransactionsRequest {
