...
impl AccountAuthorizedDepositorsNonFungibleBadge {
    pub fn new(badge_type: models::AccountAuthorizedDepositorBadgeType, resource_address: String, non_fungible_id: String, last_updated_at_state_version: i64) -> AccountAuthorizedDepositorsNonFungibleBadge {
