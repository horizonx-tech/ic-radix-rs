...
impl StateEntityDetailsResponseFungibleVaultDetails {
    pub fn new(r#type: models::StateEntityDetailsResponseItemDetailsType, resource_address: String, balance: models::FungibleResourcesCollectionItemVaultAggregatedVaultItem) -> StateEntityDetailsResponseFungibleVaultDetails {
