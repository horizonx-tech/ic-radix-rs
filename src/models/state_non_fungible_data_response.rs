...
impl StateNonFungibleDataResponse {
    pub fn new(ledger_state: models::LedgerState, resource_address: String, non_fungible_id_type: models::NonFungibleIdType, non_fungible_ids: Vec<models::StateNonFungibleDetailsResponseItem>) -> StateNonFungibleDataResponse {
