...
pub struct ResourceWithdrawOperationNotSupportedByEntityError {
    ...
    pub entity_identifier: Box<models::EntityIdentifier>,
    #[serde(rename = "resource_withdraw_not_supported")]
    pub resource_withdraw_not_supported: Box<models::ResourceIdentifier>,
}

impl ResourceWithdrawOperationNotSupportedByEntityError {
    pub fn new(r#type: String, entity_identifier: models::EntityIdentifier, resource_withdraw_not_supported: models::ResourceIdentifier) -> ResourceWithdrawOperationNotSupportedByEntityError {
