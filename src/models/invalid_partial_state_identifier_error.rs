...
pub struct InvalidPartialStateIdentifierError {
    ...
    pub invalid_partial_state_identifier: Box<models::PartialStateIdentifier>,
}

impl InvalidPartialStateIdentifierError {
    pub fn new(r#type: String, invalid_partial_state_identifier: models::PartialStateIdentifier) -> InvalidPartialStateIdentifierError {
