...
impl TransactionFungibleFeeBalanceChanges {
    pub fn new(r#type: models::TransactionFungibleFeeBalanceChangeType, entity_address: String, resource_address: String, balance_change: String) -> TransactionFungibleFeeBalanceChanges {
