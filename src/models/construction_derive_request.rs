...
pub struct ConstructionDeriveRequest {
    ...
    pub metadata: Box<models::ConstructionDeriveRequestMetadata>,
}

impl ConstructionDeriveRequest {
    pub fn new(network_identifier: models::NetworkIdentifier, public_key: models::PublicKey, metadata: models::ConstructionDeriveRequestMetadata) -> ConstructionDeriveRequest {
