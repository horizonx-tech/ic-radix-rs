...
pub struct DataObjectNotSupportedByEntityError {
    ...
    pub data_object_not_supported: Box<models::DataObject>,
}

impl DataObjectNotSupportedByEntityError {
    pub fn new(r#type: String, entity_identifier: models::EntityIdentifier, data_object_not_supported: models::DataObject) -> DataObjectNotSupportedByEntityError {
