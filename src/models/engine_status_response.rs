...
pub struct EngineStatusResponse {
    ...
    pub engine_state_identifier: Box<models::EngineStateIdentifier>,
    #[serde(rename = "validator_set")]
    pub validator_set: Vec<models::Validator>,
    #[serde(rename = "upcoming_fork", skip_serializing_if = "Option::is_none")]
    pub upcoming_fork: Option<Box<models::UpcomingFork>>,
}

impl EngineStatusResponse {
    pub fn new(engine_state_identifier: models::EngineStateIdentifier, validator_set: Vec<models::Validator>) -> EngineStatusResponse {
