...
pub struct EngineConfiguration {
    ...
    pub native_token: Box<models::TokenResourceIdentifier>,
    ...
    pub minimum_stake: Box<models::ResourceAmount>,
    #[serde(rename = "rewards_per_proposal")]
    pub rewards_per_proposal: Box<models::ResourceAmount>,
    #[serde(rename = "reserved_symbols")]
    pub reserved_symbols: Vec<String>,
    #[serde(rename = "fee_table")]
    pub fee_table: Box<models::FeeTable>,
}

impl EngineConfiguration {
    pub fn new(native_token: models::TokenResourceIdentifier, maximum_message_length: i32, maximum_validators: i32, token_symbol_pattern: String, unstaking_delay_epoch_length: i64, minimum_completed_proposals_percentage: i32, maximum_transaction_size: i64, maximum_transactions_per_round: i32, validator_fee_increase_debouncer_epoch_length: i64, maximum_rounds_per_epoch: i64, maximum_validator_fee_increase: i32, minimum_stake: models::ResourceAmount, rewards_per_proposal: models::ResourceAmount, reserved_symbols: Vec<String>, fee_table: models::FeeTable) -> EngineConfiguration {
        EngineConfiguration {
