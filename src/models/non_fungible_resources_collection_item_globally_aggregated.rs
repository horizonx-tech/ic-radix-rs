...
impl NonFungibleResourcesCollectionItemGloballyAggregated {
    pub fn new(aggregation_level: models::ResourceAggregationLevel, resource_address: String, amount: i64, last_updated_at_state_version: i64) -> NonFungibleResourcesCollectionItemGloballyAggregated {
