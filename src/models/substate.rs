...
pub struct Substate {
    ...
    pub substate_identifier: Box<models::SubstateIdentifier>,
}

impl Substate {
    pub fn new(substate_operation: SubstateOperation, substate_identifier: models::SubstateIdentifier) -> Substate {
        Substate {
            substate_operation,
