...
impl AccountAuthorizedDepositorsResourceBadge {
    pub fn new(badge_type: models::AccountAuthorizedDepositorBadgeType, resource_address: String, last_updated_at_state_version: i64) -> AccountAuthorizedDepositorsResourceBadge {
