...
pub struct NotEnoughResourcesError {
    ...
    pub r#type: String,
    #[serde(rename = "fee")]
    pub fee: Box<models::ResourceAmount>,
    #[serde(rename = "available")]
    pub available: Box<models::ResourceAmount>,
    #[serde(rename = "attempted_to_take")]
    pub attempted_to_take: Box<models::ResourceAmount>,
}

impl NotEnoughResourcesError {
    pub fn new(r#type: String, fee: models::ResourceAmount, available: models::ResourceAmount, attempted_to_take: models::ResourceAmount) -> NotEnoughResourcesError {
