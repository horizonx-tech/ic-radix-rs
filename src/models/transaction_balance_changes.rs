...
impl TransactionBalanceChanges {
    pub fn new(fungible_fee_balance_changes: Vec<models::TransactionFungibleFeeBalanceChanges>, fungible_balance_changes: Vec<models::TransactionFungibleBalanceChanges>, non_fungible_balance_changes: Vec<models::TransactionNonFungibleBalanceChanges>) -> TransactionBalanceChanges {
