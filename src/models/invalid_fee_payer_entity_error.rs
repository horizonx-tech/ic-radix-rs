...
pub struct InvalidFeePayerEntityError {
    ...
    pub invalid_fee_payer_entity: Box<models::EntityIdentifier>,
}

impl InvalidFeePayerEntityError {
    pub fn new(r#type: String, invalid_fee_payer_entity: models::EntityIdentifier) -> InvalidFeePayerEntityError {
