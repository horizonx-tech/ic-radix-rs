...
impl StateNonFungibleLocationResponse {
    pub fn new(ledger_state: models::LedgerState, resource_address: String, non_fungible_ids: Vec<models::StateNonFungibleLocationResponseItem>) -> StateNonFungibleLocationResponse {
