...
pub struct NetworkStatusResponse {
    ...
    pub pre_genesis_state_identifier: Box<models::StateIdentifier>,
    #[serde(rename = "genesis_state_identifier")]
    pub genesis_state_identifier: Box<models::StateIdentifier>,
    #[serde(rename = "current_state_identifier")]
    pub current_state_identifier: Box<models::StateIdentifier>,
    #[serde(rename = "sync_status")]
    pub sync_status: Box<models::SyncStatus>,
...
impl NetworkStatusResponse {
    pub fn new(pre_genesis_state_identifier: models::StateIdentifier, genesis_state_identifier: models::StateIdentifier, current_state_identifier: models::StateIdentifier, sync_status: models::SyncStatus, peers: Vec<models::Peer>) -> NetworkStatusResponse {
