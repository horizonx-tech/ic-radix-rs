...
pub struct PublicKeyIdentifiers {
    ...
    pub account_entity_identifier: Box<models::EntityIdentifier>,
    #[serde(rename = "validator_entity_identifier")]
    pub validator_entity_identifier: Box<models::EntityIdentifier>,
    #[serde(rename = "p2p_node")]
    pub p2p_node: Box<models::Peer>,
}

impl PublicKeyIdentifiers {
    pub fn new(account_entity_identifier: models::EntityIdentifier, validator_entity_identifier: models::EntityIdentifier, p2p_node: models::Peer) -> PublicKeyIdentifiers {
