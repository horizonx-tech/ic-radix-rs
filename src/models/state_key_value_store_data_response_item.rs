...
impl StateKeyValueStoreDataResponseItem {
    pub fn new(key: models::ScryptoSborValue, value: models::ScryptoSborValue, last_updated_at_state_version: i64, is_locked: bool) -> StateKeyValueStoreDataResponseItem {
