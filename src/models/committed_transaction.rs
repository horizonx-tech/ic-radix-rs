...
pub struct CommittedTransaction {
    ...
    pub committed_state_identifier: Box<models::StateIdentifier>,
    ...
    pub operation_groups: Vec<models::OperationGroup>,
    #[serde(rename = "metadata")]
    pub metadata: Box<models::CommittedTransactionMetadata>,
}

impl CommittedTransaction {
    /// A transaction which has been committed on ledger.
    pub fn new(transaction_identifier: models::TransactionIdentifier, committed_state_identifier: models::StateIdentifier, operation_groups: Vec<models::OperationGroup>, metadata: models::CommittedTransactionMetadata) -> CommittedTransaction {
