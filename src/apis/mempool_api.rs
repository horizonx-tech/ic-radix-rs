...
pub async fn mempool_post(configuration: &configuration::Configuration, mempool_request: models::MempoolRequest) -> Result<models::MempoolResponse, Error<MempoolPostError>> {
