...
pub async fn entity_post(configuration: &configuration::Configuration, entity_request: models::EntityRequest) -> Result<models::EntityResponse, Error<EntityPostError>> {
