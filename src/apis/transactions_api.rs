...
pub async fn transactions_post(configuration: &configuration::Configuration, committed_transactions_request: models::CommittedTransactionsRequest) -> Result<models::CommittedTransactionsResponse, Error<TransactionsPostError>> {
