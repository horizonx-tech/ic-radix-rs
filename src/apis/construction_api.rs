...
pub enum ConstructionBuildPostError {
    Status500(models::UnexpectedError),
...
pub async fn construction_build_post(configuration: &configuration::Configuration, construction_build_request: models::ConstructionBuildRequest) -> Result<models::ConstructionBuildResponse, Error<ConstructionBuildPostError>> {
...
pub async fn construction_derive_post(configuration: &configuration::Configuration, construction_derive_request: models::ConstructionDeriveRequest) -> Result<models::ConstructionDeriveResponse, Error<ConstructionDerivePostError>> {
    let local_var_configuration = configuration;
...
pub async fn construction_finalize_post(configuration: &configuration::Configuration, construction_finalize_request: models::ConstructionFinalizeRequest) -> Result<models::ConstructionFinalizeResponse, Error<ConstructionFinalizePostError>> {
    let local_var_configuration = configuration;
...
pub async fn construction_hash_post(configuration: &configuration::Configuration, construction_hash_request: models::ConstructionHashRequest) -> Result<models::ConstructionHashResponse, Error<ConstructionHashPostError>> {
    let local_var_configuration = configuration;
...
pub async fn construction_parse_post(configuration: &configuration::Configuration, construction_parse_request: models::ConstructionParseRequest) -> Result<models::ConstructionParseResponse, Error<ConstructionParsePostError>> {
    let local_var_configuration = configuration;
...
pub async fn construction_submit_post(configuration: &configuration::Configuration, construction_submit_request: models::ConstructionSubmitRequest) -> Result<models::ConstructionSubmitResponse, Error<ConstructionSubmitPostError>> {
    let local_var_configuration = configuration;
