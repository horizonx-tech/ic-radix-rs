...
pub async fn network_configuration_post(configuration: &configuration::Configuration, body: serde_json::Value) -> Result<models::NetworkConfigurationResponse, Error<NetworkConfigurationPostError>> {
...
pub async fn network_status_post(configuration: &configuration::Configuration, network_status_request: models::NetworkStatusRequest) -> Result<models::NetworkStatusResponse, Error<NetworkStatusPostError>> {
    let local_var_configuration = configuration;
